 ...
 */
export const APP_NAME = 'miniscout';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION = 'monitor health of your miniapp and make it deiscoverable';
 ...
 */
export const APP_BUTTON_TEXT = 'Give Feedback';
